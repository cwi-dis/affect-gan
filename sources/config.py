...
TRAIN_DATA = hp.HParam("Train Data Type", hp.Discrete(["real_noise", "fake_cls_categ", "fake_subjcls_categ", "fake_cls_intp", "fake_subjcls_intp", "fake_cls_intpreg", "fake_subjcls_intpreg"]))
FEATURES = ["ecg", "gsr"]
