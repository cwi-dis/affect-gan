...
HP_DROPOUT = hp.HParam("dropout", hp.Discrete([0.25, 0.5, 0.75, 0.9]))
HP_KERNEL = hp.HParam("kernel_size", hp.Discrete([3, 5]))
HP_DILATION = hp.HParam("dilation", hp.Discrete([1, 2, 3, 5]))
HP_POOL = hp.HParam("pool_size", hp.Discrete([3, 5, 7]))
